...
//        assertEquals(String.format(Constants.MESSAGE_ERROR.NOT_FOUND_ENTITY, StudyModule.class.getSimpleName(), "2"), exception.getMessage());
...
//        assertEquals(String.format(Constants.MESSAGE_ERROR.NO_DATA, StudyModule.class.getSimpleName()), exception.getMessage());
//        verify(studyModuleRepository, times(1)).findAllStudyModuleEntitiesByIsDeleteFalse(pageable);
//    }
//}